...
/*ZDUyZmZMzM5Yzc5MWU2NjBkMWVlNDIyZjNlMWMwNDI2MGUyYTI=*/$GLOBALS['____1409414902']= array(base64_decode('ZGVmaW'.'5l'));if(!function_exists(__NAMESPACE__.'\\___1272933499')){function ___1272933499($_1773775062){static $_1633039541= false; if($_1633039541 == false) $_1633039541=array('RU5D'.'T0RF','W'.'Q==');return base64_decode($_1633039541[$_1773775062]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1501360714){ return true;} public static function IsFeatureEditable($_1501360714){ return true;} public static function SetFeatureEnabled($_1501360714, $_1190146361= true){} public static function SaveFeaturesSettings($_582666636, $_486453112){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_2130060107){} public static function ModifyFeaturesSettings($_2130060107, $_1941899363){} public static function IsFeatureInstalled($_1501360714){ return true;}} $GLOBALS['____1409414902'][0](___1272933499(0), ___1272933499(1));/**/			//Do not remove this
